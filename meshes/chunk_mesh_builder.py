        ...
        for z in range(CHUNK_SIZE):
            for y in range(CHUNK_SIZE):
                ...
                if is_void((x + 1, y, z), chunk_voxels):
                    # format: x, y, z, voxel_id, face_id
                    v0 = (x + 1, y    , z    , voxel_id, 0)
                    v1 = (x + 1, y + 1, z    , voxel_id, 0)
                    v2 = (x + 1, y + 1, z + 1, voxel_id, 0)
                    v3 = (x + 1, y    , z + 1, voxel_id, 0)
                ...
                if is_void((x - 1, y, z), chunk_voxels):
                    # format: x, y, z, voxel_id, face_id
                    v0 = (x, y    , z    , voxel_id, 1)
                    v1 = (x, y + 1, z    , voxel_id, 1)
                    v2 = (x, y + 1, z + 1, voxel_id, 1)
                    v3 = (x, y    , z + 1, voxel_id, 1)
                ...
                if is_void((x, y, z - 1), chunk_voxels):
                    # format: x, y, z, voxel_id, face_id
                    v0 = (x    , y    , z, voxel_id, 0)
                    v1 = (x    , y + 1, z, voxel_id, 0)
                    v2 = (x + 1, y + 1, z, voxel_id, 0)
                    v3 = (x + 1, y    , z, voxel_id, 0)
                ...
                if is_void((x, y, z + 1), chunk_voxels):
                    # format: x, y, z, voxel_id, face_id
                    v0 = (x    , y    , z + 1, voxel_id, 1)
                    v1 = (x    , y + 1, z + 1, voxel_id, 1)
                    v2 = (x + 1, y + 1, z + 1, voxel_id, 1)
                    v3 = (x + 1, y    , z + 1, voxel_id, 1)
